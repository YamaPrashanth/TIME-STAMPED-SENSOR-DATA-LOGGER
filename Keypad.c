...
using GPIO port P1.24–P1.27 (Rows as output) and P1.20–P1.23
...
u8 KeyVal(void)
{
		...
		delay_ms(5);  // small delay for stable read
		...
		delay_ms(5);  // stabilize column decision
